...
const HeroSection = () => {
  ...
  return (
    <div className="relative sm:w-full h-[60vh] overflow-clip sm:rounded-3xl mx-auto flex justify-center items-center bg-blue-300 " >
  ...
  <input placeholder="e.g. Blog" className="rounded-full w-full h-16 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200" type="search" name="search" id="search"
