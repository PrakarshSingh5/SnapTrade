...
const Orders = () => {
  ...
  return (
   <div>
      <DashboardHeader/>
      <h1 className='text-2xl text-white font-semibold mb-5 ml-8'>Orders</h1>
      <div className='overflow-x-auto sm:ml-8'>
              <table className='w-full sm:w-[80vw] bg-white rounded-lg shadow-md'>
                  <thead>
                  <tr className='w-full  text-gray-700 uppercase border-b border-gray-200 text-sm leading-normal'>
                  ...
                  <tbody className='text-gray-600 text-sm font-light'>
                      {
                        ...
                        <tr key={order.razorpayOrderId} className='border-b border-gray-200 hover:bg-gray-100'>
                            ...
                            <td className='py-3 px-6 text-left'>
                              {role =='buyer' ? order.author.charAt(0).toUpperCase() + order.author.slice(1)
                               : order.purchaser.charAt(0).toUpperCase() + order.purchaser.slice(1) }
                               </td>
