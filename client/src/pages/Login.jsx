...
const Login = () => {
  ...
  return (
     <section className="min-h-screen flex items-stretch text-white ">
      ...
      <img src="https://images.pexels.com/photos/5083405/pexels-photo-5083405.jpeg?auto=compress&cs=tinysrgb&w=600" alt="Background Image" className="absolute inset-0 w-full sm:w-full max-h-full object-fill filter "   />
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" >
            ...
            <div className="w-full py-6 z-20">
                ...
                <form onSubmit={handleOnchange} className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                 ...
                 placeholder='xyz@gmail.com'
                    value={email}
                  onChange={(e) => setEmail(e.target.value)}  className="block w-full p-4 text-lg rounded-sm bg-black"/>
                    </div>
                    <div className="pb-2 pt-4">
